          ...
          <tr>
            <td style='padding:20px 40px;border-top:1px solid rgba(255,255,255,0.06);'>
              <p style='margin:0;font-size:11px;color:#3a3a4a;line-height:1.6;'>Este mensaje es confidencial y está destinado exclusivamente al agente indicado. © VALTASY — Todos los derechos reservados.</p>
                ...
                $mail->send();
                $_SESSION['mensaje_registro'] = "<div class='mensaje exito'><span class='msg-icon'>✓</span> ¡Agente registrado con éxito! Revisa tu correo para confirmar el acceso.</div>";
            } catch (\Throwable $e) {
                $_SESSION['mensaje_registro'] = "<div class='mensaje exito'><span class='msg-icon'>✓</span> ¡Agente registrado con éxito! (El correo de confirmación no pudo enviarse)</div>";
            }
