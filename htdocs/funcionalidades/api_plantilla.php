...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $titular = (int)$data->titular;

        // Comprobación de seguridad: El usuario es dueño de ese equipo
        ...
        // Ejecutar cambio
        $stmtUpdate = $conexion->prepare("UPDATE alineaciones SET titular = :titular WHERE id_equipo_fantasy = :id_ef AND id_jugador = :id_j");
        $stmtUpdate->execute([':titular' => $titular, ':id_ef' => $id_equipo, ':id_j' => $id_jugador]);
