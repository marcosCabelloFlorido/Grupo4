...
-- ==========================================
USE `if0_41429834_fantasyesports`;

-- ==========================================
-- 1. LIMPIEZA TOTAL (ORDEN INVERSO OBLIGATORIO)
-- ==========================================
-- Borramos una a una desde las "hijas" hasta los "padres" para evitar el error #1451
...
-- --------------------------------------------------------
-- JUGADORES (Plantillas expandidas para soportar más usuarios)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- AGENTES LIBRES (ID Equipo NULL) - Relleno crucial para evitar bloqueos
-- --------------------------------------------------------
INSERT INTO jugadores (id_equipo_profesional, nickname, nombre_real, rol, precio_mercado, media_punto) VALUES
